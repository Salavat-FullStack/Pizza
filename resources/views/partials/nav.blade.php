...
@if ($type == 'register_pizza')
    <nav class="main_nav">
        ...
        <div class="nav_panel">
            <div style="margin-left: 80px" class="account"><img class="account_logo" src="{{ asset('images/icons/account.png') }}" alt="account"><a class="auth_btn" href="{{ route('register') }}">Войти</a></div>
